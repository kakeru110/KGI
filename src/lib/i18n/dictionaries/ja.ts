...
const ja: Dictionary = {
  ...
  privacy: {
    ...
    sections: [
      {
        heading: "取得する情報",
        body: "ご予約・お問い合わせの際に、お名前・メールアドレス・電話番号をご入力いただきます。クレジットカード情報は決済代行会社（Stripe）が直接取得・管理し、当社のサーバーには保存されません。",
      },
      {
        heading: "利用目的",
        body: "取得した個人情報は、ご予約の管理・確認連絡、決済処理、お問い合わせへの対応、その他円滑な宿泊サービス提供の目的でのみ利用します。",
      },
      {
    ...
    revisionBody: "本ポリシーは予告なく変更することがあります。変更後の内容は、本ページに掲載した時点から効力を生じます。（最終改定日：2026年8月23日）",
  },
  tokushoho: {
