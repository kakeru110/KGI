...
const ja: Dictionary = {
  ...
  guestNotebook: {
    heading: "ゲストノートより",
    intro:
      "お部屋に置いているフリーノートには、ゲストの皆さまが思い思いの感想を残してくださいます。ご本人の許可をいただいたものを、匿名・要約のうえでご紹介します。",
    entries: [
      {
        season: "2026年7月",
        text: "近くの逗子海岸で6時間も泳いで真っ黒に日焼け。クラゲに刺されてしまったけど、それも含めて最高の一日だったと綴ってくれました。",
      },
      {
        season: "2026年7月",
        text: "海に行って、たくさん食べて、たくさん笑って過ごせた2日間だったと、お子さんが元気いっぱいの字で書いてくれました。",
      },
    ],
  },
  footer: {
