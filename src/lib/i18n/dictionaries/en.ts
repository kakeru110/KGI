...
const en: Dictionary = {
  ...
  guestInfo: {
    steps: ["Select dates", "Guest info", "Payment"],
    ...
    agreeSuffix: "",
    privacyPrefix: "The information you provide is handled in accordance with our ",
    privacyLinkText: "privacy policy",
    privacySuffix: ".",
    securePaymentNote: "Visa, Mastercard, JCB, and American Express accepted. Payments are processed securely by Stripe.",
  ...
  confirm: {
    ...
    checkinInfoNote: "Detailed check-in instructions will be sent to your email closer to your arrival date.",
